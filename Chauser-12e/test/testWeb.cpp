...
void loop() 
{
    ...
    if       ( request.indexOf("one") > 0 )  {  Serial.println("1"); }
    else if  ( request.indexOf("two") > 0 ) {  Serial.println("2"); client.print( html_t );}
    else if  (request.indexOf("three")>0){ Serial.println("3"); off();  }
